          ...
          <Col style={{ zIndex: 1 }} md={4}>
            <div id="first">
              <Image
                ...
                fluid
                src="/images/games-category.jpg"
              />
            </div>
            <br />
            <div id="second">
              <Image fluid src="/images/monitors-category.jpg" />
            </div>
            <br />
            <div id="third">
              <Image fluid src="/images/tablets-category.jpg" />
            </div>
            <br />
            <div id="fourth">
              <Image fluid src="/images/games-category.jpg" />
            </div>
            <br />
          </Col>
          <Col md={8}>
